// Run the Copilot scrape function live and optionally write results/*.json.
//
// Usage:
//   SCRAPELESS_API_KEY=sk_... node run.mjs
//   SCRAPELESS_API_KEY=sk_... SAVE_TEST_RESULTS=true node run.mjs

import { scrapeSearch } from "./copilot.mjs";
import fs from "node:fs";
import path from "node:path";
import { fileURLToPath } from "node:url";

const SAMPLE_PROMPT = process.env.COPILOT_SAMPLE_PROMPT ?? "top 3 smartphones in 2025, compare pricing across US marketplaces";
