# Vestiairecollective — Python surface

Async Vestiairecollective scraper built on the official [`scrapeless`](https://pypi.org/project/scrapeless/) Python SDK + Playwright over CDP.
