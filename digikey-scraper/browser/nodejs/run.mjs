...
const DEFAULT_PRODUCT_URL = "https://www.digikey.com/en/products/detail/texas-instruments/LM358N/277042";
const DEFAULT_SEARCH_QUERY = "LM358";

const SAMPLE_PRODUCT_URL = process.env.DIGIKEY_SAMPLE_PRODUCT_URL ?? DEFAULT_PRODUCT_URL;
const SAMPLE_QUERY = process.env.DIGIKEY_SAMPLE_QUERY ?? DEFAULT_SEARCH_QUERY;
