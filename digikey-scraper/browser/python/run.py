...
DEFAULT_PRODUCT_URL = "https://www.digikey.com/en/products/detail/texas-instruments/LM358N/277042"
DEFAULT_SEARCH_QUERY = "LM358"
...
async def main() -> None:
    sample_product = os.environ.get("DIGIKEY_SAMPLE_PRODUCT_URL", DEFAULT_PRODUCT_URL)
    sample_query = os.environ.get("DIGIKEY_SAMPLE_QUERY", DEFAULT_SEARCH_QUERY)
