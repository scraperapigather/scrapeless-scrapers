# Immobilienscout24 — Python surface

Async Immobilienscout24 scraper built on the official [`scrapeless`](https://pypi.org/project/scrapeless/) Python SDK + Playwright over CDP.
