...
import { scrapeProduct, scrapeSearch } from "./mercadolibre.mjs";
...
const DEFAULT_SEARCH_URL = "https://listado.mercadolibre.com.mx/tenis";

const SAMPLE_PRODUCT_URL = process.env.ML_SAMPLE_PRODUCT_URL ?? DEFAULT_PRODUCT_URL;
const SAMPLE_SEARCH_URL = process.env.ML_SAMPLE_SEARCH_URL ?? DEFAULT_SEARCH_URL;
...
saveOrPrint("search", await scrapeSearch(SAMPLE_SEARCH_URL));
