# Worten — Node.js surface

ESM Worten scraper built on the official [`@scrapeless-ai/sdk`](https://www.npmjs.com/package/@scrapeless-ai/sdk) + puppeteer-core over CDP.
