...
async def main() -> None:
    sample_product = os.environ.get("BUNNINGS_SAMPLE_PRODUCT_URL", DEFAULT_PRODUCT_URL)
    sample_query = os.environ.get("BUNNINGS_SAMPLE_QUERY", DEFAULT_QUERY)
