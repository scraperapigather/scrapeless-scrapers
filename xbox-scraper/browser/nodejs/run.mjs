...
const DEFAULT_PRODUCT_URL = "https://www.xbox.com/en-us/games/store/marvel-rivals/9N8PMW7QMD3D";
const DEFAULT_QUERY = "all";

const SAMPLE_PRODUCT_URL = process.env.XBOX_SAMPLE_PRODUCT_URL ?? DEFAULT_PRODUCT_URL;
const SAMPLE_QUERY = process.env.XBOX_SAMPLE_QUERY ?? DEFAULT_QUERY;
