# GoogleAiMode — Python surface

Async GoogleAiMode scraper built on the official [`scrapeless`](https://pypi.org/project/scrapeless/) Python SDK + Playwright over CDP.
