...
from shein import scrape_product, scrape_search, to_dict
...
PRODUCT_SCHEMA = {
    ...
    "sizes": {"type": "list", "required": True, "schema": {"type": "string"}},
...
async def test_search():
    sample_query = os.environ.get("SHEIN_SAMPLE_QUERY", "summer dress")
